...
[Unit]
Description=XRAY-Websocket Service  By VPN vibecodingxx
Documentation=${host}
...
cat> /etc/systemd/system/xray@.service << END
[Unit]
Description=XRAY-Websocket By VPN vibecodingxx
Documentation=${host}
After=network.target nss-lookup.target
...
[Unit]
Description=Multiport-Websocket Service By VPN vibecodingxx
Documentation=${host}
...
[Unit]
Description=High performance web server and a reverse proxy server by VPN vibecodingxx
Documentation=${host}
After=network.target nss-lookup.target
